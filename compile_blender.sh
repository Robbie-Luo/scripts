...
apt install -y libpugixml-dev libpcre3-dev libxml2-dev libavdevice-dev
...
compile_release embree v3.13.3 https://github.com/embree/embree.git "-DEMBREE_ISPC_SUPPORT=OFF"
